...
describe('app at step 3', () => {
  describe('add', () => {
    ...
    before((done) => {
      utils.diffContactsBeforeAndAfter('-- --memory add Chuck Norris', (diff, before, after, restore) => {
  ...
  describe('remove', () => {
    ...
    before((done) => {
      utils.diffContactsBeforeAndAfter(`-- --memory remove ${idOfTheContactToBeRemoved}`, (diff, before, after, restore) => {
